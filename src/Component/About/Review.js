    ...
    return (
        <div className='mx-3 my-20'>
            ...
            <div className='flex gap-8 justify-around mt-10'>
                <div className='text-white flex items-center'><i className="fa-solid fa-chevron-left fa-4x"
                    onClick={() => {
                        if (id == 0) {
                            setimgreview(false)
                        }
                ...
                <div className='w-96'>
                    ...
                    <div className='flex flex-col items-center mt-3'>
                        <img src={imgreview ? Sturev[id].src : Sturev[0].src} alt="Students" className='h-20 w-20 rounded-full outline outline-purple-700 outline-[0.35rem] mt-5' />
                        <h1 className='text-xl font-medium text-slate-400 mt-2 text-center'>{imgreview ? Sturev[id].name : Sturev[0].name}</h1>
                    </div>
                </div>
                <div className='text-white flex items-center'><i className="fa-solid fa-chevron-right fa-4x"
                    onClick={() => {
